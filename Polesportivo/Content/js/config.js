...
/** NOTE: Notice we have seperated out funtion calls based on user platform. 
          This cuts down significantly on memory usage and prolongs a healthy 
          user experience. 
**/
...
function setup_ios_button_demo() {

    if ($('.ios-btn-js').length) {
        $(".ios-btn-js").iButton();
        $("#ex11")
